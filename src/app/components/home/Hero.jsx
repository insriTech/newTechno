        ...
        <>
            ...
            >
                <div className='w-full h-full bg-[#00000074] flex flex-col justify-center gap-4'>
                    ...
                    <h1 className='text-8xl leading-tight font-bold text-center text-white'>Transforming Ideas into Reality </h1>
                    <h1 className='text-8xl leading-tight font-bold text-center text-white'>{displayedText}</h1>
